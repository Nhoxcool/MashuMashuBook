...
<div id="main">
	...
	<div class="head">
		<div class="col-div-6">
<span style="font-size:30px;cursor:pointer; color: #46aef7;" class="nav"  >&#9776; Tất cả Sách Cũ</span>
<span style="font-size:30px;cursor:pointer; color: #46aef7;" class="nav2"  >&#9776; Tất cả Sách Cũ</span>
</div>
